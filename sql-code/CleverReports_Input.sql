...
select CleverReports_InputTable.*, workMatch.releaseRow as Release_Actual from CleverReports_InputTable
left join workMatch on CleverReports_InputTable.ReleaseDate = workMatch.calendar_date;
